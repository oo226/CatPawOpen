...
/**
 * @param {ArrayBuffer} arrayBuffer - .docx file bytes
 * @param {{ keepPageNumbers?: boolean }} options
 */
export async function cleanDocx(arrayBuffer, options = {}) {
...
export function extractDocxTextFromParagraphs(paragraphs) {
